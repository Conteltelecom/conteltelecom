<%@ Page Title="RELATÓRIO DE PENDÊNCIAS" Language="vb" AutoEventWireup="false" MasterPageFile="~/Relatorios.master" CodeBehind="cl_rel_reducaoPendecias.aspx.vb" Inherits="conteltelecom.cl_rel_reducaoPendecias" %>
