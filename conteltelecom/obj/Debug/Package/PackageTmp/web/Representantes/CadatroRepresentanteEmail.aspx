<%@ Page Title="CADASTRO REPRESENTANTE EMAIL" Language="vb" AutoEventWireup="false" MasterPageFile="~/web/Representantes/Representante.master" CodeBehind="CadatroRepresentanteEmail.aspx.vb" Inherits="conteltelecom.CadatroRepresentanteEmail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderRepresentanteBody" runat="server">
    <telerik:RadGrid ID="RadGridEmail" runat="server" AutoGenerateColumns="False" Culture="pt-BR" DataSourceID="SqlDataSourceEmail" AllowAutomaticDeletes="True" AllowAutomaticInserts="True" AllowAutomaticUpdates="True">
