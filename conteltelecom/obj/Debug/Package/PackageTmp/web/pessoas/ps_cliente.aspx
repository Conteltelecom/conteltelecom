...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeadNormal" runat="server"></asp:Content>
    ...
    <div class="panel-body">
       ...
       <div class="form-horizontal"><br />
            ...
            <div class="form-group"> 
                ...
                <asp:Label ID="Label7" Font-Bold="true" runat="server" CssClass="col-lg-2 col-lg-offset-2 control-label"  Text="CIDADE:" ></asp:Label>
                <div class="col-lg-4">
