...
<ItemTemplate >
 ...
 <EditItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSourceUso" runat="server" CancelSelectOnNullParameter="False" ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" SelectCommand="DetailTableUso" SelectCommandType="StoredProcedure" InsertCommand="INSERT INTO SF_VL_USO(id_SF_TIPO_USO, id_OP_OPERADORAS, vlUso_SF_VL_USO, minutos_SF_VL_USO, id_SF_SERVICOS_FATURA, codNumLinha_SF_VL_USO, linhaVirtual_LI_LINHAS, id_LI_LINHAS) VALUES (@id_SF_TIPO_USO, @id_OP_OPERADORAS, @vlUso_SF_VL_USO, @minutos_SF_VL_USO, @id_SF_SERVICOS_FATURA, @codNumLinha_SF_VL_USO, @linhaVirtual_LI_LINHAS, @id_LI_LINHAS)" UpdateCommand="UPDATE SF_VL_USO SET vlUso_SF_VL_USO = @vlUso_SF_VL_USO, minutos_SF_VL_USO = @minutos_SF_VL_USO, id_OP_OPERADORAS = @id_OP_OPERADORAS, codNumLinha_SF_VL_USO = @codNumLinha_SF_VL_USO, linhaVirtual_LI_LINHAS = @linhaVirtual_LI_LINHAS, id_SF_TIPO_USO = @id_SF_TIPO_USO, id_LI_LINHAS = @id_LI_LINHAS WHERE (id_SF_VL_USO = @id_SF_VL_USO)" DeleteCommand="DELETE FROM SF_VL_USO WHERE (id_SF_VL_USO = @id_SF_VL_USO)">
        <DeleteParameters>
