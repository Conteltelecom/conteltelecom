...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderNormal" runat="server">
    ...
    <telerik:RadGrid ID="RadGridBloquiosFatura" runat="server" AutoGenerateColumns="False" MasterTableView-EditMode="InPlace" Culture="pt-BR" DataSourceID="SqlDataSourceBuscaClientes" Skin="Bootstrap" AllowSorting="True" ShowGroupPanel="True" CellSpacing="-1" GridLines="Both">
...
<GroupingSettings CollapseAllTooltip="Collapse all groups" ShowUnGroupButton="True" UnGroupButtonTooltip="DESAGRUPAR" UnGroupTooltip="">
        ...
        <ExportSettings>
            ...
            <Columns>
               ...
               <HeaderTemplate >
                ...
                <telerik:GridTemplateColumn  Aggregate="Sum"  FooterAggregateFormatString="TOTAL: {0}" DataField="percentValor" GroupByExpression="percentValor group BY percentValor"  FilterControlAltText="Filter percentValor column" HeaderText="VALOR CONTEL" UniqueName="percentValor">
                    <EditItemTemplate>
                        <asp:Label ID="percentValorLabelEdit" runat="server" Text='<%# Eval("percentValor", "{0:C}") %>'></asp:Label>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="percentValorLabel" runat="server" Text='<%# Eval("percentValor", "{0:C}") %>'></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle CssClass="col-xs-1" />
                </telerik:GridTemplateColumn>
                ...
                <telerik:GridTemplateColumn>
                            <ItemTemplate>
                                ...
                                <asp:hyperlink ID="RadImageButtonFuturar" runat="server" Width="32px" Height="32px" NavigateUrl='<%# String.Format("~/web/clientes/relatorios/cl_rel_reducao.aspx?id_PS_PESSOA={0}&mesAnoRefereincia_SF_SERVICOS_FATURA={1}", Eval("codMatriz_PS_CLIENTES"), Session("DtMes01")) %>'  Target="_blank" CommandName="Faturar" Text="" ImageUrl="~/img/dollar.png"  ></asp:hyperlink>
    ...
    <asp:SqlDataSource ID="SqlDataSourceBuscaClientes" CancelSelectOnNullParameter="False" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecom %>" SelectCommand="SP_Listafaturas" UpdateCommand="UPDATE SF_SOLICITACAO_FATURA SET id_ADM_CAD_TIPO_BLOQUEIO = @id_ADM_CAD_TIPO_BLOQUEIO, id_PS_PESSOA_USUARIO = @id_PS_PESSOA_USUARIO WHERE (id_codMatriz_PS_CLIENTES = @id_codMatriz_PS_CLIENTES) AND (mesAnoRefereincia_SF_SERVICOS_FATURA = @mesAnoRefereincia_SF_SERVICOS_FATURA)" SelectCommandType="StoredProcedure">
        <SelectParameters>
        ...
        <UpdateParameters>
            ...
            <asp:SessionParameter Name="id_PS_PESSOA_USUARIO" SessionField="id_PS_PESSOA_USUARIO" />
