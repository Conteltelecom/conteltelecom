<%@ Page Title="DETALHES DE CLIENTES" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MasterPageCli.master" CodeBehind="ps_cliente_detalhes.aspx.vb" Inherits="conteltelecom.ps_cliente_detalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder12" runat="server">
                    ...
                    <div class=" form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 control-label" style="text-align: left !important">
                                <asp:Label ID="Label7" runat="server" Font-Bold="false" Text='<%#Me.FcnpjFormat(Eval("CNPJ_PS_JURIDICA")) %>' />
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 control-label" style="text-align: left !important">
                                <asp:Label ID="Label32" Font-Bold="false" runat="server" Text='<%# Me.MacaraCep(Eval("cep_PS_PESSOA")) %>' />
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <InsertItemTemplate>
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="LabelCondI"  runat="server"  CssClass="col-lg-2 control-label" Font-Bold="true" Text="CÓDIGO:"></asp:Label>
                                <div class="col-lg-10">
                                    <asp:Label ID="Labelid_PS_PESSOAI" runat="server" CssClass="col-lg-2 control-label"></asp:Label>
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="desc_PS_CIDADESLabeNome" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="NOME FANTASIA:"></asp:Label>
                                <div class="col-lg-10">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label10I" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true"  Text="RAZÃO SOCIAL:"></asp:Label>
                                <div class="col-lg-10">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label11i" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="CNPJ:"></asp:Label>
                                <div class="col-lg-4 ">
                                ...
                                <asp:Label ID="Label12I" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="INS. ESTADUAL:"></asp:Label>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label21I" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="CÓD DA MATRIZ"></asp:Label>
                                <div class="col-lg-4">
                                    <telerik:RadAutoCompleteBox ID="RadAutoCompleteBoxMatriz_ins"  runat="server" AutoPostBack="true" Width="100%" TextSettings-SelectionMode="Single"    OnTextChanged="RadAutoCompleteBoxMatriz_ins_TextChanged" DataSourceID="SqlDataSourceBuscaMatriz" DataModelID="SqlDataSourceBuscaMatriz"   DataTextField="desc_PS_PESSOA" DataValueField="id_PS_PESSOA"></telerik:RadAutoCompleteBox>
                                   
                                    <asp:TextBox ID="TextBoxcodMatriz_PS_CLIENTES_Ins" Width="100%" AutoPostBack ="true"  runat="server" Text='<%# Bind("codMatriz_PS_CLIENTES") %>' CssClass="form-control" OnTextChanged="TextBoxcodMatriz_PS_CLIENTES_Ins_TextChanged"  Visible="false" />
                                      </div>
                                <div class="col-lg-6">
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label13I" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="UF:"></asp:Label>
                                <div class="col-lg-4">
                                
                                    <telerik:RadDropDownList ID="RadDropDownListuF_Ins"  Width="100%" OnSelectedIndexChanged="RadDropDownListuF_SelectedIndexChanged" runat="server" DataSourceID="SqlDataSourceUf" DataTextField="cod_PS_UF" DataValueField="cod_PS_UF" Skin="Bootstrap" AutoPostBack="True" DefaultMessage=" "  DropDownHeight="150"> </telerik:RadDropDownList>
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorUf_Ins" ControlToValidate="RadDropDownListuF_Ins" ErrorMessage="* Campo obrigatório." Display="Dynamic" ValidationGroup="Sim" runat="server" ForeColor="Red" InitialValue=" "  />
                                </div>
                                <asp:Label ID="Label17i" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="CIDADES:"></asp:Label>
                                <div class="col-lg-4">
                                 
                                            <asp:TextBox ID="TextBoxid_PS_CIDADES_Ins" runat="server" Visible="false"></asp:TextBox>

                                            <telerik:RadDropDownList ID="RadDropDownListCidade_Ins" Width="100%" runat="server" DataSourceID="SqlDataSourceDropGrid" DataTextField="desc_PS_CIDADES" DataValueField="id_PS_CIDADES" Skin="Bootstrap" AutoPostBack="True" DefaultMessage="" DropDownHeight="150"></telerik:RadDropDownList>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorCidade_ins" ControlToValidate="RadDropDownListCidade_Ins" ErrorMessage="* Campo obrigatório." Display="Dynamic" ValidationGroup="Sim" runat="server" ForeColor="Red" InitialValue=" "  />
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label15i" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="BAIRRO:"></asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBoxbairro_PS_PESSOA_Ins" Width="100%" runat="server" CssClass="form-control" />
                                </div>
                                <asp:Label ID="Label16I" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="CEP:"></asp:Label>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label14i" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="RUA:"></asp:Label>
                                <div class="col-lg-10">
                                    <asp:TextBox ID="TextBoxendereco_PS_PESSOA_Ins" Width="100%" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label18i" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="NÚMERO:"></asp:Label>
                                <div class="col-lg-4 ">
                                ...
                                <asp:Label ID="Label19I" runat="server" Font-Bold="true" CssClass="col-lg-2 control-label" Text="COMPLEMENTO:"></asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBoxcomplemeto_PS_PESSOA_Ins" Width="100%" runat="server" CssClass="form-control" />
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label20I" runat="server" Font-Bold="true" CssClass="col-lg-2 control-label" Text="OBSERVAÇÕES:"></asp:Label>
                                <div class="col-lg-10 ">
        ...
        <EditItemTemplate>
                    ...
                    <div style="text-align: right !important">
                        <telerik:RadButton ID="UpdateButton" runat="server"  UseSubmitBehavior ="false"   CommandName="Update"  Text="SALVAR" ToolTip="SALVAR">
                            <Icon PrimaryIconUrl="../../img/accept.png" />
                        </telerik:RadButton>
                        <telerik:RadButton ID="CancelButton" runat="server"  CausesValidation="False" UseSubmitBehavior="false"  CommandName="Cancel" Text="CANCELAR" ToolTip="CANCLEAR">
                            <Icon PrimaryIconUrl="../../img/block.png" />
                        </telerik:RadButton>
                    </div> 
                                 <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label40" runat="server" CssClass="col-lg-2 control-label" Text="CÓDIGO:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-10">
                                    <asp:Label ID="Labelid_PS_PESSOA" runat="server" CssClass="col-lg-2 control-label" Text='<%# Bind("id_PS_PESSOA") %>'></asp:Label>
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="desc_PS_CIDADESLabel2" runat="server" CssClass="col-lg-2 control-label" Text="NOME FANTASIA:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-10">
                                    <asp:TextBox ID="TextBoxdesc_PS_PESSOA" Width="100%" runat="server" CssClass="form-control" Text='<%# Bind("desc_PS_PESSOA") %>' />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ControlToValidate="TextBoxdesc_PS_PESSOA" SetFocusOnError="true"  ErrorMessage="* Campo obrigatório." Display="Dynamic" runat="server" ForeColor="Red"  />
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label10" runat="server" CssClass="col-lg-2 control-label" Text="RAZÃO SOCIAL:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-10">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label11" runat="server" CssClass="col-lg-2 control-label" Text="CNPJ:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4 ">
                                    <telerik:RadMaskedTextBox ID="RadMaskedTextBoxCnpj" AutoPostBack ="true"  Width="100%" Mask="##.###.###/####-##" CssClass="form-control" Text='<%# Bind("CNPJ_PS_JURIDICA") %>' runat="server"></telerik:RadMaskedTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorTextBoxCNPJ_PS_JURIDICA" ControlToValidate="RadMaskedTextBoxCnpj"  SetFocusOnError="true"  ErrorMessage="* Campo obrigatório." Display="Dynamic" runat="server" ForeColor="Red" ValidationGroup="Sim" />
                                </div>
                                <asp:Label ID="Label12" runat="server" CssClass="col-lg-2 control-label" Text="INSCRIÇÃO ESTADUAL:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label21" runat="server" CssClass="col-lg-2 control-label" Text="CÓD DA MATRIZ" Font-Bold="true"></asp:Label>
                                <div class="col-lg-2">
                                   <asp:TextBox ID="TextBoxcodMatriz_PS_CLIENTES" Width="100%" AutoPostBack ="true"  runat="server" Text='<%# Bind("codMatriz_PS_CLIENTES") %>' CssClass="form-control" OnTextChanged="TextBoxcodMatriz_PS_CLIENTES_Ins_TextChanged"  Visible="false" />
                                   <telerik:RadAutoCompleteBox ID="RadAutoCompleteBoxMatriz"  Width="100%" AutoPostBack="true"   runat="server" InputType="Text"   TextSettings-SelectionMode="Single"  OnTextChanged="RadAutoCompleteBoxMatriz_ins_TextChanged" DataSourceID="SqlDataSourceBuscaMatriz" DataModelID="SqlDataSourceBuscaMatriz"  DataTextField="desc_PS_PESSOA" DataValueField="id_PS_PESSOA"></telerik:RadAutoCompleteBox>
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label13" runat="server" CssClass="col-lg-2 control-label" Text="UF:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBoxuF" runat="server" Visible="false" Text='<%# Bind("cod_PS_UF") %>'></asp:TextBox>
                                    <telerik:RadDropDownList ID="RadDropDownListuF" DropDownHeight="150" Width="100%" OnSelectedIndexChanged="RadDropDownListuF_SelectedIndexChanged" SelectedValue='<%# Eval("cod_PS_UF") %>' runat="server" DataSourceID="SqlDataSourceUf" DataTextField="cod_PS_UF" DataValueField="cod_PS_UF" Skin="Bootstrap" AutoPostBack="True"></telerik:RadDropDownList>
                                </div>
                                <asp:Label ID="Label17" runat="server" CssClass="col-lg-2 control-label" Text="CIDADES:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                                
                                    <asp:TextBox ID="TextBoxid_PS_CIDADES" runat="server" Visible="false" Text='<%# Bind("id_PS_CIDADES") %>'></asp:TextBox>

                                    <telerik:RadDropDownList ID="RadDropDownListCidade" Width="100%" runat="server" DataSourceID="SqlDataSourceDropGrid" DataTextField="desc_PS_CIDADES" DataValueField="id_PS_CIDADES" Skin="Bootstrap" AutoPostBack="True" DropDownHeight="150"></telerik:RadDropDownList>

                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label15" runat="server" CssClass="col-lg-2 control-label" Text="BAIRRO:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBoxbairro_PS_PESSOA" Width="100%" runat="server" CssClass="form-control" Text='<%# Bind("bairro_PS_PESSOA") %>' />
                                </div>
                                <asp:Label ID="Label16" runat="server" CssClass="col-lg-2 control-label" Text="CEP:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                            ...
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label14" runat="server" CssClass="col-lg-2 control-label" Text="RUA:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-10">
                                    <asp:TextBox ID="TextBoxendereco_PS_PESSOA" Width="100%" runat="server" CssClass="form-control" Text='<%# Bind("endereco_PS_PESSOA") %>' />
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label18" runat="server" CssClass="col-lg-2 control-label" Text="NÚMERO:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4 ">
                                ...
                                <asp:Label ID="Label19" runat="server" CssClass="col-lg-2 control-label" Text="COMPLEMENTO:" Font-Bold="true"></asp:Label>
                                <div class="col-lg-4">
                                    <asp:TextBox ID="TextBoxcomplemeto_PS_PESSOA" Width="100%" runat="server" CssClass="form-control" Text='<%# Bind("complemeto_PS_PESSOA") %>' />
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label20" runat="server" CssClass="col-lg-2 control-label" Text="OBSERVAÇÕES:"  Font-Bold="true"></asp:Label>
                                <div class="col-lg-10 ">
                                    <asp:TextBox ID="TextBoxobs_PS_PESSOA" runat="server" Width="100%" CssClass="form-control" TextMode="MultiLine"  Height="150px" Text='<%# Bind("obs_PS_PESSOA") %>' />
    ...
    <asp:SqlDataSource ID="SqlDataSourceBuscaMatriz" runat="server" CancelSelectOnNullParameter="False"  ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" SelectCommand="RadAutoCompleteBoxPs_Juridica" SelectCommandType="StoredProcedure">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourcePessaoas" CancelSelectOnNullParameter="False" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" SelectCommand="RadGridPessoas" SelectCommandType="StoredProcedure" InsertCommand="INSERT INTO PS_PESSOA(desc_PS_PESSOA, endereco_PS_PESSOA, numEndereco_PS_PESSOA, bairro_PS_PESSOA, cep_PS_PESSOA, id_PS_CIDADES, complemeto_PS_PESSOA, obs_PS_PESSOA, st_PS_PESSOA, tipoCadastro_PS_PESSOA) VALUES (@desc_PS_PESSOA, @endereco_PS_PESSOA, @numEndereco_PS_PESSOA, @bairro_PS_PESSOA, @cep_PS_PESSOA, @id_PS_CIDADES, @complemeto_PS_PESSOA, @obs_PS_PESSOA, @st_PS_PESSOA, @tipoCadastro_PS_PESSOA)" UpdateCommand="UPDATE PS_PESSOA SET desc_PS_PESSOA = @desc_PS_PESSOA, endereco_PS_PESSOA = @endereco_PS_PESSOA, numEndereco_PS_PESSOA = @numEndereco_PS_PESSOA, bairro_PS_PESSOA = @bairro_PS_PESSOA, cep_PS_PESSOA = @cep_PS_PESSOA, id_PS_CIDADES = @id_PS_CIDADES, complemeto_PS_PESSOA = @complemeto_PS_PESSOA, obs_PS_PESSOA = @obs_PS_PESSOA, st_PS_PESSOA = @st_PS_PESSOA, tipoCadastro_PS_PESSOA = @tipoCadastro_PS_PESSOA WHERE (id_PS_PESSOA = @id_ps_pessoa)">
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="CheckBoxMostrarTodos" Type="Int32" />
            <asp:Parameter DefaultValue="1" Name="CheckBoxMostrarFiliais" Type="Int32" />
        </SelectParameters>
        <UpdateParameters>
            <asp:Parameter Name="desc_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="endereco_PS_PESSOA"  ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="numEndereco_PS_PESSOA" ConvertEmptyStringToNull="true"   />
            <asp:Parameter Name="bairro_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="cep_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="id_PS_CIDADES" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="complemeto_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="obs_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="st_PS_PESSOA"  ConvertEmptyStringToNull="true" />
            <asp:Parameter Name="tipoCadastro_PS_PESSOA" ConvertEmptyStringToNull="true"  />
            <asp:Parameter Name="id_ps_pessoa"  ConvertEmptyStringToNull="true" />
        </UpdateParameters>
    </asp:SqlDataSource>
