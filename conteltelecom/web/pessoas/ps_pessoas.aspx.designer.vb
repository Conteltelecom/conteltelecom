...
Partial Public Class ps_pessoas
    ...
    '''<summary>
    '''Controle TextBoxCodFim.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents TextBoxCodFim As Global.System.Web.UI.WebControls.TextBox
    ...
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents TextBoxCpf As Global.System.Web.UI.WebControls.TextBox
    ...
    '''<summary>
    '''Controle RadGridPessoaFisica.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents RadGridPessoaFisica As Global.Telerik.Web.UI.RadGrid
    
    '''<summary>
    '''Controle SqlDataSourcePs_PessoaFisica.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents SqlDataSourcePs_PessoaFisica As Global.System.Web.UI.WebControls.SqlDataSource
End Class
