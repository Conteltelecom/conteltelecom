...
Partial Public Class cl_rel_reducao
    ...
    '''<summary>
    '''Controle RadGridPendecias.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents RadGridPendecias As Global.Telerik.Web.UI.RadGrid
    
    '''<summary>
    '''Controle ObjectDataSourceBuscaPendecias.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents ObjectDataSourceBuscaPendecias As Global.System.Web.UI.WebControls.ObjectDataSource
    
    '''<summary>
    '''Controle ReportViewerRelReducao.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
