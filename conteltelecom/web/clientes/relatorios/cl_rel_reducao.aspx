...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderRelatorio" runat="server">
    ...
    <telerik:RadGrid ID="RadGridPendecias" runat="server" AutoGenerateColumns="False" Culture="pt-BR" DataSourceID="ObjectDataSourceBuscaPendecias" GroupPanelPosition="Top" Skin="Bootstrap">
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        <ExportSettings>
            <Pdf PageWidth="">
            </Pdf>
        </ExportSettings>
        <MasterTableView DataSourceID="ObjectDataSourceBuscaPendecias" Caption="PENDÊCIAS">
            <Columns>
    ...
    <div style="width:100%; height:100%">
        <rsweb:ReportViewer ID="ReportViewerRelReducao" AsyncRendering="true"  runat="server"  Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" Height="100%">
