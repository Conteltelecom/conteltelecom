<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Relatorios.master" CodeBehind="cl_rel_reducaoPendecias.aspx.vb" Inherits="conteltelecom.cl_rel_reducaoPendecias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderRelatorio" runat="server">
     ...
     <asp:ObjectDataSource ID="ObjectDataSourceBuscaCodRazao" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="conteltelecom.Ds_ClientecodRazaoTableAdapters.COD_PS_JURIDICATableAdapter"></asp:ObjectDataSource>
            ...
            <rsweb:ReportViewer ID="ReportViewerRelReducao"  runat="server"  Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="11in" Width="9in" >
        <LocalReport ReportPath="rdcl\clientes\RelReducaoPendecias.rdlc">
            <DataSources>
