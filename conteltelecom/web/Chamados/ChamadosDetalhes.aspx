...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderNormal" runat="server">
                ...
                <telerik:GridTemplateColumn DataField="texto_CH_HISTORICO" FilterControlAltText="Filter texto_CH_HISTORICO column" HeaderText="texto_CH_HISTORICO" SortExpression="texto_CH_HISTORICO" UniqueName="texto_CH_HISTORICO">
                    ...
                    <ItemTemplate>
                        <table>
                            <tr>
                                <td>
                                    <b>Descrição:</b>:<asp:Label ID="Label2" runat="server" Text='<%# Eval("texto_CH_HISTORICO") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td><b>Status:</b></b><asp:Label ID="desc_CH_STATUSLabel" runat="server" Text='<%# Eval("desc_CH_STATUS") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td><b>Alteração Realizado por </b><asp:Label ID="Label24" runat="server" Text='<%# Eval("desc_PS_PESSOA") %>'></asp:Label> em <asp:Label ID="LabeldtaHora" runat="server" Text='<%# Eval("dtInc_CH_HISTORICO") %>'></asp:Label>,o prazo final para ao atendimento do chamado é<asp:Label ID="LabeldtPrazoTarefa_CH_HISTORICO" runat="server" Text='<%# Eval("dtPrazoTarefa_CH_HISTORICO") %>'></asp:Label> 
                                </td>
                                                            </tr>
                    ...
                    <HeaderTemplate>
                        <table class="rgMasterTable" style="width: 100%">
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th colspan="1">
                                        <asp:Label ID="LabelNumChamado" runat="server" Font-Bold="true" Text="Nº/SEQ"></asp:Label>
                                        </th> 
                                    <th colspan="3">
                            ...
                            <tbody>
                                <tr class="rgEditRow">
                                     <td class="col-xs-3" colspan="1">
                                        <asp:Label ID="LabelNumChamado_seq" runat="server" Font-Bold="true" Text="ggg"></asp:Label>
                                    </td>
                    ...
                    <fieldset class="form-group" style="border: 1px solid #ccc; padding: 10px;">
                        <table style="width: 100%" >
                            <colgroup>
                                ...
                                <tr>
                                    <th colspan="1">
                                        <asp:Label ID="Label11" runat="server" Font-Bold="true" Text="ALTERAR DATA DO CHAMADO PARA:"></asp:Label>
                                    </th>
                                     <th colspan="3">
                                         </th>
                                </tr>
                            ...
                            <tbody>
                                <tr class="rgEditRow">
                                    <td class="col-xs-3" colspan="1">
                                        <telerik:RadDatePicker ID="RadDatePickerDataAgendamento"  Width ="95%" MinDate='<%#DateTime.Today.Date %>'  runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceNovo" runat="server"  ConnectionString="<%$ ConnectionStrings:conteltelecom %>" SelectCommand="SELECT CH_HISTORICO.texto_CH_HISTORICO, CH_HISTORICO.id_CH_HISTORICO, CH_HISTORICO.id_CH_SUBCHAMADOS, CH_STATUS.desc_CH_STATUS, CH_HISTORICO.dtAlt_CH_HISTORICO, CH_SUBCHAMADOS.emAtendimentoPor_id_PS_PESSOA, CH_TIPO_TAREFA.id_CH_SETORES, CH_TIPO_TAREFA.id_CH_TIPO_TAREFA, PS_PESSOA_1.desc_PS_PESSOA AS NomeEmpresa, CH_SUBCHAMADOS.email_CH_SUBCHAMADOS, CH_SUBCHAMADOS.contato_CH_SUBCHAMADOS, CH_SUBCHAMADOS.telefone_CH_SUBCHAMADOS, CH_SUBCHAMADOS.dtAbertura_CH_SUBCHAMADOS, CH_SUBCHAMADOS.dtFim_CH_SUBCHAMADOS, CH_SUBCHAMADOS.assunto_CH_SUBCHAMADOS, CH_SUBCHAMADOS.abertoPor_id_PS_PESSOA, CH_TIPO_TAREFA.id_CH_PRIORIDADE, CH_PRIORIDADE.desc_CH_PRIORIDADE, CH_SUBCHAMADOS.dtPrazoTarefa_CH_SUBCHAMADOS, CH_SETORES.desc_CH_SETORES, CH_TIPO_TAREFA.desc_CH_TIPO_TAREFA, CH_STATUS.id_CH_STATUS, CH_HISTORICO.id_PS_PESSOA_inc, PS_PESSOA.desc_PS_PESSOA, CH_HISTORICO.dtInc_CH_HISTORICO, CH_HISTORICO.dtPrazoTarefa_CH_HISTORICO FROM CH_HISTORICO INNER JOIN CH_STATUS ON CH_HISTORICO.id_CH_STATUS = CH_STATUS.id_CH_STATUS INNER JOIN CH_SUBCHAMADOS ON CH_HISTORICO.id_CH_SUBCHAMADOS = CH_SUBCHAMADOS.id_CH_SUBCHAMADOS INNER JOIN CH_TIPO_TAREFA ON CH_SUBCHAMADOS.id_CH_TIPO_TAREFA = CH_TIPO_TAREFA.id_CH_TIPO_TAREFA INNER JOIN CH_CHAMADOS ON CH_SUBCHAMADOS.id_CH_CHAMADOS = CH_CHAMADOS.id_CH_CHAMADOS INNER JOIN PS_PESSOA AS PS_PESSOA_1 ON CH_CHAMADOS.idEmpresa_Pessoa = PS_PESSOA_1.id_PS_PESSOA INNER JOIN CH_PRIORIDADE ON CH_TIPO_TAREFA.id_CH_PRIORIDADE = CH_PRIORIDADE.id_CH_PRIORIDADE INNER JOIN CH_SETORES ON CH_TIPO_TAREFA.id_CH_SETORES = CH_SETORES.id_CH_SETORES INNER JOIN PS_PESSOA ON CH_HISTORICO.id_PS_PESSOA_inc = PS_PESSOA.id_PS_PESSOA WHERE (CH_SUBCHAMADOS.id_CH_CHAMADOS = @id_CH_CHAMADOS) AND (CH_SUBCHAMADOS.numSeq_CH_SUBCHAMADOS = @numSeq_CH_SUBCHAMADOS) ORDER BY CH_HISTORICO.id_PS_PESSOA_inc DESC" InsertCommand="INSERT INTO CH_HISTORICO(texto_CH_HISTORICO, id_CH_SUBCHAMADOS, id_PS_PESSOA_alt, id_CH_STATUS, id_CH_SETORES, emAtendimentoPor_id_PS_PESSOA, id_PS_PESSOA_inc, dtPrazoTarefa_CH_HISTORICO) VALUES (@texto_CH_HISTORICO, @id_CH_SUBCHAMADOS, @id_PS_PESSOA_alt, @id_CH_STATUS, @id_CH_SETORES, @emAtendimentoPor_id_PS_PESSOA, @id_PS_PESSOA_inc, @dtPrazoTarefa_CH_HISTORICO)" UpdateCommand="UPDATE CH_SUBCHAMADOS SET id_CH_STATUS = @id_CH_STATUS, emAtendimentoPor_id_PS_PESSOA = @emAtendimentoPor_id_PS_PESSOA, dtFim_CH_SUBCHAMADOS = @dtFim_CH_SUBCHAMADOS, dtPrazoTarefa_CH_SUBCHAMADOS = @dtPrazoTarefa_CH_SUBCHAMADOS WHERE (id_CH_SUBCHAMADOS = @id_CH_SUBCHAMADOS)">
        <InsertParameters>
            ...
            <asp:Parameter Name="dtPrazoTarefa_CH_HISTORICO" Type="String" />
        </InsertParameters>
        <SelectParameters>
        ...
        <UpdateParameters>
            <asp:Parameter Name="id_CH_STATUS" />
            <asp:Parameter Name="emAtendimentoPor_id_PS_PESSOA" />
            <asp:Parameter Name="dtFim_CH_SUBCHAMADOS" />
            <asp:Parameter Name="dtPrazoTarefa_CH_SUBCHAMADOS" />
            <asp:Parameter Name="id_CH_SUBCHAMADOS" />
        </UpdateParameters>
    </asp:SqlDataSource>
