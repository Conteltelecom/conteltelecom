    ...
    <div class="panel-body">
       ...
       <div class="form-horizontal"><br />
           ...
           <div class="form-group"> 
                <asp:Label ID="LabelCodIni0" CssClass="col-lg-2 control-label"  Font-Bold="true" runat="server" Text="DATA:" ></asp:Label>
                <div class="col-lg-4">
                    <telerik:RadDatePicker ID="RadDatePickerFiltroInicial" runat="server"></telerik:RadDatePicker>
                </div> 
                <asp:Label ID="Label4" CssClass="col-lg-2 control-label"  Font-Bold="true" runat="server" Text="DATA:" ></asp:Label>
                <div class="col-lg-4">
                    <telerik:RadDatePicker ID="RadDatePickerFiltroDataFim" runat="server"></telerik:RadDatePicker>
                </div> 
            </div>
            <div class="form-group"> 
                <asp:Label ID="Label1" Font-Bold="true" CssClass="col-lg-2 control-label"  runat="server" Text="NOME FANTASIA" ></asp:Label>
                <div class="col-lg-4">
                    <asp:TextBox ID="TextBoxIni" CssClass="form-control"  runat="server" ></asp:TextBox>
                   
                </div>
                <asp:Label ID="Label2" Font-Bold="true" CssClass="col-lg-2 control-label"  runat="server" Text="TAREFA" ></asp:Label>
                <div class="col-lg-4">
                    <telerik:RadDropDownList ID="RadDropDownListFiltroTarefa" runat="server"></telerik:RadDropDownList>
...
<br />
 <telerik:RadMenu ID="RadMenuAtendimentos" runat="server" EnableRoundedCorners="true" EnableShadows="true" Skin="Bootstrap">
    ...
    <telerik:RadGrid ID="RadGridChamados" runat="server" AutoGenerateColumns="False" Culture="pt-BR" DataSourceID="SqlDataSourceAbrirChamado" CellSpacing="-1" GridLines="Both">
        ...
        <MasterTableView DataKeyNames="id_CH_CHAMADOS,id_CH_SUBCHAMADOS" DataSourceID="SqlDataSourceAbrirChamado">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="razaosocial_PS_JURIDICA" FilterControlAltText="Filter PS_JURIDICA.razaosocial_PS_JURIDICA column" HeaderText="RAZÃO SOCIAL" UniqueName="PS_JURIDICA.razaosocial_PS_JURIDICA">
                ...
                <telerik:GridBoundColumn DataField="desc_CH_TIPO_TAREFA" FilterControlAltText="Filter desc_CH_TIPO_TAREFA column" HeaderText="TAREFA" UniqueName="desc_CH_TIPO_TAREFA">
                    <HeaderStyle CssClass="col-xs-3" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="dtPrazoTarefa_CH_SUBCHAMADOS" DataType="System.DateTime" FilterControlAltText="Filter dtFim_CH_SUBCHAMADOS column" DataFormatString ={0:d} HeaderText="PRAZO" SortExpression="dtPrazoTarefa_CH_SUBCHAMADOS" UniqueName="dtPrazoTarefa_CH_SUBCHAMADOS">
                    <HeaderStyle CssClass="col-xs-1" />
                </telerik:GridBoundColumn>
                <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumn">
                    <ItemTemplate>
                        <asp:HiddenField ID="HiddenFieldid_CH_STATUS" runat="server" Value='<%#Eval("id_CH_STATUS")%>' />
                                                <asp:HiddenField ID="HiddenFieldid_CH_SETORES" runat="server" Value='<%#Eval("id_CH_SETORES")%>' />
                 ...
                 <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumnAtender">
                    <ItemTemplate>
                        <telerik:RadButton ID="RadButtonAtender" runat="server" AutoPostBack="true" Text="ATENDER"   CommandName="ATENDER">
                    ...
                    <fieldset class="form-group" style="border: 1px solid #ccc; padding: 10px;">
                        <table class="rgMasterTable" style="width: 100%">
                            ...
                            <tbody>
                                <tr class="rgEditRow">
                                    <td class="col-xs-3" colspan="1">
                                        ...
                                        <telerik:RadSearchBox  OnSearch ="RadSearchBoxBuscaPessoa_Search" ID="RadSearchBoxBuscaPessoa" Width="95%" runat="server" Culture="pt-BR" on DataSourceID="SqlDataSourceClientesNomeFantasia" DataTextField="CLIENTE" DataValueField="codMatriz_PS_CLIENTES"></telerik:RadSearchBox>
                                     
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadTextBox1" ValidationGroup="Sim" ControlToValidate="RadTextBox1" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="col-xs-3" colspan="1">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadSearchBoxBuscaPessoa" ValidationGroup="Sim" ControlToValidate="RadTextBoxNomeContato" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="col-xs-3" colspan="1">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadTextBoxEmail" ValidationGroup="Sim" ControlToValidate="RadTextBoxEmail" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="col-xs-3" colspan="1">
                                       ...
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadMaskedTextBoxFone" ValidationGroup="Sim" ControlToValidate="RadMaskedTextBoxFone" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr class="rgEditRow">
                                    <td class="col-xs-3" colspan="1">
                                        <telerik:RadDropDownList Width="99%" ID="RadDropDownListSetor" AutoPostBack="true" AppendDataBoundItems="false" runat="server" DataSourceID="SqlDataSourceSetores" DataTextField="desc_CH_SETORES" OnSelectedIndexChanged="RadDropDownListSetor_SelectedIndexChanged" DataValueField="id_CH_SETORES" DropDownHeight="150px" SelectedValue='<%# Bind("id_CH_SETORES") %>'></telerik:RadDropDownList>

                                    </td>
                                    <td class="col-xs-3" colspan="1">
                               
                                            
                                            <telerik:RadDropDownList ID="RadDropDownListTarefas" Width="99%" AppendDataBoundItems="false" runat="server" DataSourceID="SqlDataSourceTarefas" DataTextField="desc_CH_TIPO_TAREFA" DataValueField="id_CH_TIPO_TAREFA" DropDownHeight="150px" ></telerik:RadDropDownList>
                                   ...
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadTextBoxAssunto" ValidationGroup="Sim" ControlToValidate="RadTextBoxAssunto" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                           </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr class="rgEditRow">
                                    <td class="col-xs-3" colspan="4">
                                       ...
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidatorRadEditorHistorico" ValidationGroup="Sim"  ControlToValidate="RadEditorHistorico" runat="server" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="RED"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th colspan="1">
                                        <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="ENCAMINHAR O CHAMADO PARA"></asp:Label>
                            ...
                            <tfoot style="width: 100%">
                                <tr class="rgRow">
                                    <td class="rgEditForm">
                                        ...
                                        <telerik:RadImageButton ID="RadImageButtonOK" ValidationGroup="Sim" runat="server" Skin="" CssClass="gEditForm [type='image']" Width="32px" Height="32px" Image-Url="~/img/accept_32.png" CommandName='<%# IIf(DataBinder.Eval(Container, "OwnerTableView.IsItemInserted"), "PerformInsert", "Update") %>'>
    ...
    <asp:SqlDataSource ID="SqlDataSourceTarefas" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecom %>" SelectCommand="SELECT desc_CH_TIPO_TAREFA, id_CH_TIPO_TAREFA FROM View_DropDown_CH_TIPO_TAREFAS WHERE (id_CH_SETORES = @id_CH_SETORES)">
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSourceAtendentes" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecom %>" SelectCommand="SELECT PS_PESSOA.desc_PS_PESSOA, PS_PESSOA.id_PS_PESSOA, USUARIOS.atendeChamado_USUARIOS FROM USUARIOS INNER JOIN PS_PESSOA ON USUARIOS.id_PS_PESSOA = PS_PESSOA.id_PS_PESSOA INNER JOIN PS_SETOR_USUARIO ON USUARIOS.id_USUARIOS = PS_SETOR_USUARIO.id_USUARIOS WHERE (USUARIOS.st_USUARIOS = 1) AND (PS_PESSOA.st_PS_PESSOA = 1) AND (USUARIOS.atendeChamado_USUARIOS = 1) AND (PS_SETOR_USUARIO.id_CH_SETORES = @id_CH_SETORES)">
        <SelectParameters>
            <asp:Parameter Name="id_CH_SETORES" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSourceUpdateChamadosEmatendimento" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecom %>" SelectCommand="SELECT id_CH_CHAMADOS FROM CH_CHAMADOS" UpdateCommand="UPDATE CH_SUBCHAMADOS SET emAtendimentoPor_id_PS_PESSOA = @emAtendimentoPor_id_PS_PESSOA, id_CH_STATUS = 2 WHERE (id_CH_CHAMADOS = @id_CH_CHAMADOS) AND (numSeq_CH_SUBCHAMADOS = @numSeq_CH_SUBCHAMADOS)" InsertCommand="INSERT INTO CH_HISTORICO(id_CH_SUBCHAMADOS, id_CH_STATUS, id_CH_SETORES, emAtendimentoPor_id_PS_PESSOA, texto_CH_HISTORICO, id_PS_PESSOA_alt, id_PS_PESSOA_inc) VALUES (@id_CH_SUBCHAMADOS, @id_CH_STATUS, @id_CH_SETORES, @emAtendimentoPor_id_PS_PESSOA, @texto_CH_HISTORICO, @id_PS_PESSOA_alt, @id_PS_PESSOA_inc)">
        <InsertParameters>
