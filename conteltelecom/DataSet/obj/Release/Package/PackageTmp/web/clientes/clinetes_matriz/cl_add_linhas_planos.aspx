...
<ItemTemplate >
 ...
 <EditItemTemplate>
    ...
    <telerik:RadGrid ID="RadGridLinhas02"  AllowMultiRowSelection="True"   runat="server" Culture="pt-BR" DataSourceID="SqlDataSourceLinhas02"  GroupPanelPosition="Top" Skin="Bootstrap" AutoGenerateColumns="False" CellSpacing="-1" GridLines="Both" >
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        ...
        <MasterTableView DataSourceID="SqlDataSourceLinhas02" ExpandCollapseColumn-Display = "false"   ExpandCollapseColumn-Visible = "false"   HierarchyDefaultExpanded="true" NoDetailRecordsText = "SEM REGISTROS" DataKeyNames="id_LI_LINHAS,codLinha_LI_LINHAS,id_OP_OPERADORAS,codMatriz_PS_CLIENTES" CommandItemDisplay="TopAndBottom" AllowAutomaticUpdates="False" AllowNaturalSort="False" >
            ...
            <DetailTables>
                <telerik:GridTableView runat="server" NoDetailRecordsText = "SEM REGISTROS"  DataKeyNames="id_LI_LINHAS" DataSourceID="SqlDataSourceLinhas3" AllowAutomaticUpdates="False" AllowNaturalSort="False" Name="Linhas" ShowHeader="false"  >
                    <ParentTableRelation>
