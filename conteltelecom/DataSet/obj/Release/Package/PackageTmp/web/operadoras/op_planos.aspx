...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
        ...
        <MasterTableView DataKeyNames="id_OP_PLANOS" DataSourceID="SqlDataSourcePlanosOperadora" EditMode="InPlace" CommandItemDisplay="Top" NoMasterRecordsText="SEM REGISTROS"  >
            ...
            <Columns>
                ...
                <telerik:GridDropDownColumn DataSourceID="ObjectDataSourceOperadora" FilterControlAltText="Filter id_OP_OPERADORAS column" HeaderText="OPERADORA" ListTextField="desc_OP_OPERADORAS" ListValueField="id_OP_OPERADORAS" UniqueName="id_OP_OPERADORAS" DataField="id_OP_OPERADORAS">
