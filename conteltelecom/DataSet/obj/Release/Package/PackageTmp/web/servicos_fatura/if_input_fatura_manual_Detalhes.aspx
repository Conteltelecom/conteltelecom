...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderNormal" runat="server">
  ...
  <asp:UpdatePanel ID="UpdatePaneDetailTableServico" runat="server"><ContentTemplate >
    ...
    <telerik:RadGrid ID="RadGridServicosXFaturas" runat="server" AutoGenerateColumns="False" MasterTableView-ExpandCollapseColumn-Display="false" MasterTableView-ExpandCollapseColumn-Visible="false" Culture="pt-BR" DataSourceID="SqlDataSourceLinhas" GroupPanelPosition="Top" Skin="Bootstrap" Style="margin-top: 0px">
...
<ItemTemplate >
 ...
 <EditItemTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSourceLinhasXCod" CancelSelectOnNullParameter="False" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" SelectCommand="DropDownLinhasXCodLinha" SelectCommandType="StoredProcedure" InsertCommand="INSERT INTO SF_VL_SERVICO(id_SF_SERVICOS_FATURA, desc_SF_VL_SERVICO, qtDias_SF_VL_SERVICO, vl_SF_VL_SERVICO, vlDesconto_SF_VL_SERVICO, codNumLinha_SF_VL_SERVICO) VALUES (@id_SF_SERVICOS_FATURA, @desc_SF_VL_SERVICO, @qtDias_SF_VL_SERVICO, @vl_SF_VL_SERVICO, @vlDesconto_SF_VL_SERVICO, @codNumLinha_SF_VL_SERVICO)">
      ...
      <asp:SqlDataSource ID="SqlDataSourceDuplicaruso" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" InsertCommand="INSERT INTO SF_VL_USO(id_SF_TIPO_USO, id_OP_OPERADORAS, vlUso_SF_VL_USO, minutos_SF_VL_USO, id_SF_SERVICOS_FATURA, codNumLinha_SF_VL_USO) SELECT id_SF_TIPO_USO, id_OP_OPERADORAS, vlUso_SF_VL_USO, minutos_SF_VL_USO, id_SF_SERVICOS_FATURA, codNumLinha_SF_VL_USO FROM SF_VL_USO AS SF_VL_USO_1 WHERE  id_SF_VL_USO=  @id_SF_VL_USO" SelectCommand="SELECT id_SF_VL_USO FROM SF_VL_USO WHERE (id_SF_SERVICOS_FATURA = @id_SF_SERVICOS_FATURA)">
          <InsertParameters>
              <asp:Parameter Name="id_SF_VL_USO" />
          </InsertParameters>
          <SelectParameters>
      ...
      <asp:SqlDataSource ID="SqlDataSourceServico" runat="server" ConnectionString="<%$ ConnectionStrings:conteltelecomConnectionString %>" InsertCommand="INSERT INTO SF_VL_SERVICO(id_SF_SERVICOS_FATURA, desc_SF_VL_SERVICO, qtDias_SF_VL_SERVICO, vl_SF_VL_SERVICO, vlDesconto_SF_VL_SERVICO, codNumLinha_SF_VL_SERVICO) SELECT id_SF_SERVICOS_FATURA, desc_SF_VL_SERVICO, qtDias_SF_VL_SERVICO, vl_SF_VL_SERVICO, vlDesconto_SF_VL_SERVICO, codNumLinha_SF_VL_SERVICO FROM SF_VL_SERVICO AS SF_VL_SERVICO_1 WHERE id_SF_VL_SERVICO = @id_SF_VL_SERVICO " SelectCommand="SELECT id_SF_VL_SERVICO FROM SF_VL_SERVICO WHERE (id_SF_SERVICOS_FATURA = @id_SF_SERVICOS_FATURA)">
          <InsertParameters>
              <asp:Parameter Name="id_SF_VL_SERVICO" />
          </InsertParameters>
          <SelectParameters>
