<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Menu.master" CodeBehind="ps_pessoas_detalhes.aspx.vb" Inherits="conteltelecom.ps_pessoas_detalhes" %>
            ...
            <fieldset class="fieldsetForms">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label24" Font-Bold="false" runat="server" Text='<%# Me.TelefoneFormat(Eval("fone01_PS_FISICA")) %>' />
                        </td>
                        <td>
                            <asp:Label ID="Label25" runat="server"  Font-Bold="true" Text="TELEFONE:" />
                        </td>
                        <td>
                            <asp:Label ID="Label26" Font-Bold="false" runat="server" Text='<%# Me.TelefoneFormat(Eval("fone02_PS_FISICA")) %>' />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="col-lg-4">
                                    <telerik:RadMaskedTextBox ID="RadMaskedTextBoxcpf_PS_FISICA_Ins" AutoPostBack="true" OnTextChanged="RadMaskedTextBoxcpf_PS_FISICA_Ins_TextChanged" Width="100%" Mask="###.###.###-##" CssClass="form-control" runat="server">
                                    </telerik:RadMaskedTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorcpf_PS_FISICA_Ins" ControlToValidate="RadMaskedTextBoxcpf_PS_FISICA_Ins" ErrorMessage="* Campo obrigatório." Display="Dynamic" runat="server" ForeColor="Red" />
                                </div>
                                <asp:Label ID="Label1_ins" runat="server" CssClass="col-lg-2 control-label" Text="DATA NASCIMENTO:"></asp:Label>
                                <div class="col-lg-4">
                                    <telerik:RadDatePicker ID="RadDatePickerdt_nasc_PS_FISICA_ins" Width="100%" runat="server"></telerik:RadDatePicker>
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <asp:Label ID="Label4" runat="server" CssClass="col-lg-2 control-label" Text="TELEFONE:"></asp:Label>
                                <div class="col-lg-4">
            ...
            <asp:UpdatePanel ID="UpdatePanelRadDataForm" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            <div class="col-lg-12 form-group">
                                <asp:Label ID="Label14" runat="server" CssClass="col-lg-2 control-label" Text="NOME:"></asp:Label>
                                <div class="col-lg-10">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="col-lg-4">
                                    <telerik:RadMaskedTextBox ID="RadMaskedTextBoxcpf_PS_FISICA" AutoPostBack="true" Text='<%# Eval("cpf_PS_FISICA") %>' OnTextChanged="RadMaskedTextBoxcpf_PS_FISICA_Ins_TextChanged" Width="100%" Mask="###.###.###-##" CssClass="form-control" runat="server">
                                    </telerik:RadMaskedTextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorcpf_PS_FISICA" ControlToValidate="RadMaskedTextBoxcpf_PS_FISICA" ErrorMessage="* Campo obrigatório." Display="Dynamic" runat="server" ForeColor="Red" />
                                </div>
                                <asp:Label ID="Label1" runat="server" CssClass="col-lg-2 control-label" Text="DATA NASCIMENTO:"></asp:Label>
                                <div class="col-lg-4">
                                    <telerik:RadDatePicker ID="RadDatePickerdt_nasc_PS_FISICA" Width="100%" runat="server"></telerik:RadDatePicker>
                                </div>
                            </div>
                            <div class="col-lg-12 form-group">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <asp:Label ID="LabelFone02" runat="server" CssClass="col-lg-2 control-label" Text="TELEFONE:"></asp:Label>
                                <div class="col-lg-4">
                    ...
                    <fieldset class="fieldsetForms">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="col-lg-10 ">
                                    <asp:TextBox ID="TextBoxobs_PS_PESSOA" Text='<%# Eval("obs_PS_PESSOA") %>' runat="server" Width="100%" CssClass="form-control" Height="150px" />

                                </div>
                            </div>
                            <div class="form-group">
                                <asp:Label ID="LabelSituacao" runat="server" CssClass="col-lg-2 control-label" Font-Bold="true" Text="SITUAÇÃO:" />
                                <asp:CheckBox ID="CheckBoxst_PS_PESSOA" CssClass="col-lg-2" Checked='<%# Eval("st_PS_PESSOA") %>' runat="server" />
