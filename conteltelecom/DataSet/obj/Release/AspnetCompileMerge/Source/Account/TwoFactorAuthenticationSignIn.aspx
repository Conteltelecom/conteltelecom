<%@ Page Title="Autenticação de dois fatores" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="conteltelecom.TwoFactorAuthenticationSignIn" %>
