<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Menu.master" CodeBehind="ps_pessoas.aspx.vb" Inherits="conteltelecom.ps_pessoas" %>
...
<GroupingSettings CollapseAllTooltip="Collapse all groups"></GroupingSettings>
         ...
         <MasterTableView DataSourceID="SqlDataSourcePs_PessoaFisica"    Width="100%" CommandItemDisplay="Top" AllowPaging="True" AllowSorting="True"  >
             <CommandItemSettings AddNewRecordText="NOVO" CancelChangesText="CANCELAR" AddNewRecordImageUrl="../../img/add.png" RefreshText="ATUALIZAR" SaveChangesText="SALVAR" />
                              <Columns>
                                  ...
                                  <telerik:GridBoundColumn DataField="fone01_PS_FISICA" FilterControlAltText="Filter fone01_PS_FISICA column" HeaderText="TELEFONE" UniqueName="fone01_PS_FISICA">
                                      <HeaderStyle CssClass="col-lg-2" />
                                      <ItemStyle CssClass="col-lg-2" />
                                  </telerik:GridBoundColumn>
                                  <telerik:GridTemplateColumn FilterControlAltText="Filter SITUACAO column" HeaderText="SITUAÇÃO" UniqueName="SITUACAO">
                                      <ItemTemplate>
