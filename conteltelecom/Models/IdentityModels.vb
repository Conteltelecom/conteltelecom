...
' Você pode adicionar dados de perfil para o usuário adicionando mais propriedades para sua Classe de usuário, visite http://go.microsoft.com/fwlink/?LinkID=317594 para saber mais.
